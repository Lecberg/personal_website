(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))d(i);new MutationObserver(i=>{for(const s of i)if(s.type==="childList")for(const m of s.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&d(m)}).observe(document,{childList:!0,subtree:!0});function a(i){const s={};return i.integrity&&(s.integrity=i.integrity),i.referrerPolicy&&(s.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?s.credentials="include":i.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function d(i){if(i.ep)return;i.ep=!0;const s=a(i);fetch(i.href,s)}})();const x=[{id:"northern-metropolis",title:"Northern Metropolis Spatial Analysis",period:"Sep 2025 - Dec 2025",tags:["GWR Analysis","Python"],color:"brand",icon:"fa-map",summary:"Performed GWR analysis on employment categories using integrated census and Foursquare POI data. Demonstrated superior explanatory power (R² > 0.5) and generated 2033 job distribution predictions.",fullDescription:`
    ...
    `).join(""))}function $(){const e=window.innerWidth-document.documentElement.clientWidth;e>0&&(document.body.style.paddingRight=`${e}px`),document.body.style.overflow="hidden"}function E(){document.body.style.overflow="",document.body.style.paddingRight=""}function w(e){const t=x.find(a=>a.id===e);!t||!b||!r||(b.innerHTML=`
